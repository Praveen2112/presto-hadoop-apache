...
public class ProtobufRpcEngine implements RpcEngine {
    ...
    private static class Invoker implements RpcInvocationHandler {
        ...
        private final Supplier<Client.ConnectionId> remoteId;
            ...
            this(protocol, () -> {
                        try {
                            return ConnectionId.getConnectionId(
                                            addr, protocol, UserGroupInformation.getCurrentUser(), rpcTimeout, connectionRetryPolicy, conf);
                        }
                        catch (IOException e) {
         ...
         */
        private Invoker(Class<?> protocol, Supplier<Client.ConnectionId> connId,
        ...
        public Message invoke(Object proxy, final Method method, Object[] args)
            ...
            try {
                val = (RpcWritable.Buffer) client.call(RPC.RpcKind.RPC_PROTOCOL_BUFFER,
                        new RpcProtobufRequest(rpcRequestHeader, theRequest), remoteId.get(),
